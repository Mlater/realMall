package com.mrxc.mockData;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.mrxc.logWeb.logSendWeb;
import com.mrxc.util.RanOpt;
import com.mrxc.util.RandomDate;
import com.mrxc.util.RandomNum;
import com.mrxc.util.RandomOptionGroup;
...
public class jsonMock {
    ...
    private String appId = "LaterMall";
    ...
    private RanOpt[] eventOpts = {new RanOpt("addFavor", 10), new RanOpt("addComment", 30),
            new RanOpt("addCart", 20), new RanOpt("clickItem", 4), new RanOpt("coupon", 85)};
    ...
    private String initStartsupLog() {
        ...
        String uid = "" + RandomNum.getRandInt(1, 800);
